    ...
    return (
        <article className="border m-2 p-2 hover:shadow-lg">
            <div className="flex flex-col sm:flex-row justify-between">
                <h2 className="text-center self-center m-2">{book ? book.title : ""}</h2>
            ...
            <div className="flex flex-col sm:flex-row">
                <img className="mx-auto m-2 sm:mx-2 self-start" src={book ? book.thumbnail : "https://via.placeholder.com/150"} alt="Book Cover" />
                <p className="m-2">{book ? book.synopsis : ""}</p>
            </div>
        </article>
    );
}
