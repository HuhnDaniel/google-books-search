...
function BookCard({ book, index, handleDeleteClick }) {
    return (
        <article className="border m-2 p-2 hover:shadow-lg">
            <div className="flex flex-col sm:flex-row justify-between">
                ...
                <div className="flex flex-row items-center self-center">
                    ...
                    <button className="m-2 self-end bg-red-400 w-16 rounded-lg hover:shadow-outline" name={index} type="button" onClick={handleDeleteClick}>Delete</button>
                </div>
            </div>
